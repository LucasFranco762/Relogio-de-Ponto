...
class JourneysPage(QWidget):
    ...
    def __init__(self, database: Database) -> None:
        ...
        date_filters.addWidget(QLabel("Até")); date_filters.addWidget(self.end_date)
        refresh = QPushButton("Atualizar"); refresh.clicked.connect(self.refresh); date_filters.addWidget(refresh)
        recalculate = QPushButton("Recalcular período"); recalculate.clicked.connect(self.recalculate); date_filters.addWidget(recalculate)
